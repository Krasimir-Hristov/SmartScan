      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            {locales.map((loc) => (
              ...
              >
                ...
                <span
                  ...
                  aria-hidden="true"
                />
                <span className="font-mono font-medium uppercase">{loc.code}</span>
              </span>
            ))}
          </div>
        </div>
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold text-white font-display">SmartScan Stay</p>
          ...
          {/* Nav Links */}
          <nav className="flex flex-wrap items-center justify-center gap-6 text-xs text-zinc-400" aria-label="Footer Navigation">
